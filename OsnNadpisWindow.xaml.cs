...
namespace DocGOST
{
    ...
    public partial class OsnNadpisWindow : Window, IDisposable
    {
        ...
        public OsnNadpisWindow(string projecPath)
        {
            ...
            gr13TextBox.Text = project.GetOsnNadpisItem("13")?.perechenValue ?? "";
        ...
        private void Save()
        {
            ...
            try { 
                ...
                osnNadpisItem.specificationValue = gr13TextBox.Text;
                osnNadpisItem.perechenValue = gr13TextBox.Text;
                osnNadpisItem.vedomostValue = gr13TextBox.Text;
                osnNadpisItem.pcbSpecificationValue = gr13TextBox.Text;
                project.SaveOsnNadpisItem(osnNadpisItem);
